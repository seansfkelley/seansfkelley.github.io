...
The smaller shape represents the underlying framework for the whole system. Call it the <span class="one">foundation</span>. The larger one is where all the domain logic lives. Call it the <span class="two">specialization</span>.
