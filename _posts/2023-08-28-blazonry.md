...
- <a href="#" data-example>Barry of six Vair and Gules.</a>
    <br>
    &nbsp;&nbsp;arms of the [Lords of Coucy](https://en.wikipedia.org/wiki/Lords_of_Coucy)
...
- <a href="#" data-example>Parted per bend Azure and Argent, a tree eradicated counterchanged.</a>
    <br>
    &nbsp;&nbsp;arms of the [Sir Bedivere as seen in _Monty Python and the Holy Grail_](https://m.imdb.com/title/tt0071853/mediaviewer/rm2935199233) (the shield, not the surcoat)
...
[^1]: Not _exactly_; I had to add "in pale" in one place but I'm not sure if mine or the original would be considered more correct.
