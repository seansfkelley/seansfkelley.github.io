// Verbatim from https://github.com/Yqnn/svg-path-editor at 89cd74b9790301b9975ebb09fd6b1570133516fc, then Prettiered
...
class HorizontalLineTo extends SvgItem {
  ...
  protected override refreshAbsolutePoints(origin: Point, previous: SvgItem | null) {
    ...
    if (this.relative) {
      this.absolutePoints = [
        new SvgPoint(this.values[0] + this.previousPoint.x, this.previousPoint.y),
      ];
    } else {
...
class VerticalLineTo extends SvgItem {
  ...
  protected override refreshAbsolutePoints(origin: Point, previous: SvgItem | null) {
    ...
    if (this.relative) {
      this.absolutePoints = [
        new SvgPoint(this.previousPoint.x, this.values[0] + this.previousPoint.y),
      ];
    } else {
