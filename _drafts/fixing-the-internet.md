...
subtitle: "or: Facebook Succeeded Where Yahoo! Failed"
---
...
Many tech companies have used the network effect, walled garden strategy, or both, to grab and keep market share. Social media, almost by definition, relies on the network effect. Google, Apple, Amazon, Netflix do it too, to varying degrees... but Yahoo! tried it years before all of them.

-------------------------------------------------------------------------------

Yahoo! has had a tumultuous history, which is very apparent from one look at [the Wikipedia page listing its services](https://en.wikipedia.org/wiki/List_of_Yahoo!-owned_sites_and_services). There are echoes of modern-day social media all over it: the pre-Reddit [Yahoo! Buzz](https://en.wikipedia.org/wiki/Yahoo!_Buzz) (launched 2000), proto-Pinterest [del.icio.us](https://en.wikipedia.org/wiki/Delicious_(website)) (founded 2003, acquired 2005), needs-no-introduction [GeoCities](https://en.wikipedia.org/wiki/Yahoo!_GeoCities) (founded 1994, acquired 1999) and the [recently, tragically discontinued alternate reality](https://www.washingtonpost.com/technology/2021/05/04/yahoo-answers-babby/) that was [Yahoo! Answers](https://en.wikipedia.org/wiki/Yahoo!_Answers) (launched 2005). That's not to mention Yahoo!'s direct competitors of [Twitter](https://en.wikipedia.org/wiki/Yahoo!_Meme) and [YouTube](https://en.wikipedia.org/wiki/Yahoo!_Screen). For comparison: Facebook was launched in 2004.

Feature-for-feature, Facebook doesn't appear to do anything significantly different that Yahoo! didn't try first, with the glaring exception of _having user identities that tied everything together_. While there are certainly many overlapping reasons Yahoo! is a walking internet relic and Facebook isn't,[^6] the one that stands out is the near-nonexistent network effect. I could make my own GeoCities site, but I couldn't neatly use, say, Yahoo! Answers to engage with interested visitors. I could share bookmark lists with friends on del.icio.us, but the only connection between that and sharing the same links on Yahoo! Buzz was to copy-paste the URLs.

Yahoo! was a bunch of independent communities wearing matching colors. In this way, Yahoo! seems to have adhered to the early-internet ethos that prized decentralization. Each product did one thing, so if you wanted to do that thing, you'd know where to go. It was, in a sense, vertically integrated, and like many vertically integrated things, it ended up siloed.
...
[^6]: In addition to the lack of user identities in the style of Facebook, I'll speculate that Yahoo! suffered from too-goofy branding, lack of focus, an inability to be "cool" as the incumbent... and perhaps simple lack of desire to become a social network.
